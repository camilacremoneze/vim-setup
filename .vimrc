...
"Este plugin executa os testes - make test
Plugin 'neomake/neomake'
"Este plugin tem gde valia, mas deixa a abertura dos arquvios lentas
"por isso foram comentadas as linhas do syntastic
...
"Este plugin precisa de um setup para set da linguagem
Plugin 'LanguageTool'

"" Git Support
"Todos esses plugins sao para uso do vim
...
"Este plugin gera codigo, nao eh mto eficiente
...
"Acho que isso aqui embaixo pode buggar. Se sim, comentar
...
" Configs to format when saving/reload dir
